...
async function restoreBackup(event: Event) {
  ...
  if (!window.confirm('导入会覆盖当前浏览器中的设置、任务、成品模板、提示词构建数据和图库。建议先导出备份。确定继续吗？')) return
  ...
  <div class="h-full overflow-y-auto px-6 pb-44 pt-5">
    <div class="mx-auto max-w-[760px]">
      ...
      <section class="rise-in mb-5 rounded-2xl border border-line bg-well p-5 shadow-card" style="--stagger: 4">
        ...
        <p class="mt-3 text-[10.5px] leading-relaxed text-red/75">完整备份包含图片、任务、成品模板、提示词构建数据、设置以及 API Key，请像保管密钥一样保管备份文件。</p>
      </section>
